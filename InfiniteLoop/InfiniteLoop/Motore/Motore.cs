...
namespace Rotore
{
    public class Motore : IEnumerable<Dente[]>, IEnumerator<Dente[]>
    {
        #region privates
        private List<Ingranaggio> ingranaggi = null;
        private Ingranaggio primoIngranaggi = null;
